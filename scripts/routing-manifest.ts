...
const EXTRA_ROUTING_CASES: RoutingEvalCase[] = [
  ...
  { prompt: 'show exact raw base transactions for this onchain investigation', expected: 'portal_evm_query_transactions', max_rank: 1, source: 'extra' },
  { prompt: 'what contract address does bored apes resolve to', expected: 'portal_resolve_entity', max_rank: 1, source: 'extra' },
  ...
  { prompt: 'show me program instructions on solana', expected: 'portal_solana_query_instructions', max_rank: 1, source: 'extra' },

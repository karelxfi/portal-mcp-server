...
if (portalRegistrationCount !== 30) {
  throw new Error(`Expected all 30 tools on registerPortalTool(), found ${portalRegistrationCount}`)
}
...
console.log(
  `Lean surface OK: ${runtimeReachable.size} runtime modules, ${appBuildReachable.size} app build modules, ${sourceLines} source lines, 30/30 instrumented registrations, 0 legacy surfaces`,
)

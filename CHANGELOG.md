...
- Added a repo-local marketplace entry so Codex can install `sqd@sqd-portal` from this repository.
...
- Renamed the Codex plugin selector to `sqd@sqd-portal`, and set the public plugin version to `0.8.0`.
